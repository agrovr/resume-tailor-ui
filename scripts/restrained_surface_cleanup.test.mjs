...
test("saved work rows use quiet surfaces without decorative side rails", () => {
  for (const stylesheet of [globals, settingsStyles, studioStyles]) {
  ...
  assert.doesNotMatch(globals, /\.settings-project-item,\s*\.settings-document-item,\s*\.studio-account-recent-link\s*\{/s);
