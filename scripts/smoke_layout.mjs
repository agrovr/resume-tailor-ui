...
const PAGE_CHECKS = [
  ...
  },
  {
    ...
    textFitSelectors: [
      ...
      ".help-search-intro strong",
      ".help-search-intro small",
      ".help-search-field input",
      ".help-search-meta span",
    ...
    containedSelectors: [
      ...
      { container: ".legal-shell", selector: ".help-search-card", tolerance: 4 },
      { container: ".help-search-card", selector: ".help-search-intro", tolerance: 4 },
      { container: ".help-search-card", selector: ".help-search-field", tolerance: 4 },
      { container: ".help-search-card", selector: ".help-search-meta", tolerance: 4 },
  ...
  },
  {
    ...
    textFitSelectors: [
      ...
      ".legal-hero-card span",
      ".legal-index-head strong",
      ".legal-index-head small",
    ...
    containedSelectors: [
      { container: ".legal-shell", selector: ".legal-hero", tolerance: 4 },
      { container: ".legal-shell", selector: ".legal-index", tolerance: 4 },
      { container: ".legal-shell", selector: ".legal-grid", tolerance: 4 },
      { container: ".legal-shell", selector: ".legal-footer-card", tolerance: 4 },
      { container: "closest:.legal-index", selector: ".legal-index a strong", tolerance: 4 },
      { container: "closest:.legal-card", selector: ".legal-card h2", tolerance: 4 },
      { container: "closest:.legal-card", selector: ".legal-card p", tolerance: 4 },
    ],
  },
